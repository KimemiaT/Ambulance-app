...
//
//            try {
//                testUpload(filePath1,"Certificate");
//                testUpload(filePath1,"Licence");
//            }catch (Exception e){
//                e.printStackTrace();
//            }
    ...
    private void testUpload(Uri imageUri, String category) {
        StorageReference ref = storageReference.child("Certificates and Licenses/"+ phoneNumber + "/" + name).child(System.currentTimeMillis()+".jpg");
